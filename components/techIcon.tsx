...
export default function TechIcon(props: props) {
  ...
  return (
    <div className="object-fit flex justify-center items-center h-fit p-[2px] rounded-sm">
      <Image className="object-contain" title={`Made with ${tech[0].toLocaleUpperCase() + tech.slice(1)}.`} alt={tech} width={size || 12} height={size || 12} src={"/icons/" + tech + "-icon.png"}></Image>
    </div>
  );
}
