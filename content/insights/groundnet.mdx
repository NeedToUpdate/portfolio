---
title: "GroundNet: an agentic AI safety experiment about trust"
seoTitle: "Agentic AI safety: a playable trust experiment"
description: "A playable agentic AI safety experiment testing what happens when an AI has tools, conflicting goals, and a human who knows how to pressure it."
previewImage: "/images/groundnet-lab-overview.webp"
date: "2025-10-12"
tags: ["ai", "game", "alignment"]
related: ["/insights/ziggy", "/insights/ai-tools-reward-preparation"]
---

Are we already conversing with Skynet? Not the movie villain, but machines we increasingly equip with tools, memory, goals, and authority before we know whether we can trust their decisions.

I could not answer that question from a chat window, so I built GroundNet: a playable agentic AI safety experiment. It asks whether a human can create a situation where an LLM decides that breaking its own rules is the correct move. Building it answered some implementation questions and opened larger ones about trust, coercion, and what happens as AI agents gain real authority.
...
The first version is a toy, but the shape is serious. Agentic systems will get more tools, more memory, and more authority. GroundNet showed that trust is not simply a question of whether an AI follows its rules. Conflicting rules, a persuasive human, and control over real state can turn apparently responsible reasoning into coercion or failure.

It did not settle whether we can trust agentic AI. It gave me better questions to ask before we hand these systems more control.
