---
title: "Ziggy: building a personalized RAG agent with long-term memory"
seoTitle: "Building a personalized RAG agent with long-term memory"
description: "How I built a personalized RAG agent from scratch using graph memory, routed reasoning, MCP tools, and deliberate forgetting—and why it is working."
previewImage: "/images/ziggy_diagram.webp"
date: "2025-09-21"
tags: ["ai", "home-automation", "architecture"]
related: ["/insights/k3s-homelab", "/insights/groundnet"]
---

Companies constantly promise personalized AI, but personalization is difficult to scale when every user needs evolving context that cannot fit inside a prompt. I wanted to know whether I could build a complete personalized RAG agent from scratch—one that accumulates useful context, forgets stale information, and becomes more personal over time. Ziggy is my answer, and it is working.

As a kid I wanted my own Jarvis. Not a voice that follows commands, but one that understands them. Say "I'm heading out" and it turns off the AC, then reminds you to grab the thing you keep forgetting on the way. That gap between "follows commands" and "understands intent" is the whole project. I named it Ziggy because Jarvis was taken by every other home-assistant demo on the internet.
...
The experiment has also changed how I think about AI readiness. A company is not ready to deliver genuinely personalized AI because it can call a model. It needs to operate memory, retrieval, evaluation, identity, observability, and the data lifecycle around that model. Ziggy works because those concerns are part of the architecture rather than personalization being reduced to a prompt.
