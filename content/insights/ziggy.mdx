...
<FloatImage
  src="/images/ziggy_diagram.webp"
  alt="A stylized diagram of a brain wired to six tool icons: a database, sharing, gears, a container, a clock, and Python"
  side="none"
  caption="One router, several specialized tools. The brain analogy, illustrated."
/>
