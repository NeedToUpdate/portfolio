---
title: "My k3s homelab: can spare hardware run an enterprise-grade platform?"
seoTitle: "Can spare hardware run an enterprise-grade homelab?"
description: "I combined two old laptops, a homemade server, and two mini PCs to test whether spare hardware could support HA Kubernetes, GitOps, SSO, and zero open ports."
